---
title: "List roles"
description: "Get a list of the Viva Engage roles and their properties."
author: "richafnu"
...
[!INCLUDE [permissions-table](../includes/permissions/employeeexperience-list-role-permissions.md)]
...
If successful, this method returns a `200 OK` response code and a list of roles in the response body.

## Example: Get a list of roles 
